import static Utils.UtilClass.countWords;
import static Utils.UtilClass.showMap;

public class Main {

    public static void main(String[] args) {
        showMap(countWords(new String[]{"Алексей", "Олег", "Анатолий", "Алексей", "Дмитрий", "Олег", "Иван", "Иван",
                "Анатолий", "Алексей"}));

        PhoneBook book = PhoneBook.getInstance();
        /*
        book.add("Алексей","911");
        book.add("Иван","02");
        book.add("Алексей","911");
        book.add("Анатолий","03");
        book.add("Алексей","911");
        book.add("Иван","002");

        System.out.println(book.get("Крыс"));
         */
    }
}
